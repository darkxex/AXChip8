...
LIBS	:=	-lSDL2_ttf -lSDL2_gfx -lSDL2_image -lSDL2_mixer -lpng -lwebp -ljpeg -lvorbisidec -logg -lmpg123 -lmodplug `aarch64-none-elf-pkg-config --libs SDL2_mixer` `sdl2-config --libs` `freetype-config --libs` -lcurl -lmbedtls -lmbedx509 -lmbedcrypto -lz -lnx
